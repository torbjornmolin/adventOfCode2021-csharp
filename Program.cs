        ...
        static void Main(string[] args)
        {
            ...
            switch (day)
            {
                ...
                case "day6_part2":
                    ...
                    break;
                case "day7_part1":
                    selectedDay = new Day7_Part1();
                    break;
                case "day7_part2":
                    selectedDay = new Day7_Part2();
                    break;
                case "day8_part1":
                    selectedDay = new Day8_Part1();
                    break;
                case "day8_part2":
                    selectedDay = new Day8_Part2();
                    break;
                case "day9_part1":
                    selectedDay = new Day9_Part1();
                    break;
                case "day9_part2":
                    selectedDay = new Day9_Part2();
                    break;
                case "day10_part1":
                    selectedDay = new Day10_Part1();
                    break;
                case "day10_part2":
