namespace adventofcode2021
{
    public class Day4_Part2 : IDay
    {
        ...
        public void Test(string input)
        {
            ...
            Assert.AreEqual(PlayGame(input), 1924, "Game plays correctly for test input");
        }
        ...
        private int PlayGame(string input)
        {
            ...
            var currentBoards = game.BingoBoards.ToList();
            var winners = new List<BingoBoard>();
            foreach (var n in game.Numbers)
            {
                var remainingBoards = new List<BingoBoard>();
                for (int i = 0; i < currentBoards.Count; i++)
                {
                    BingoBoard? board = currentBoards[i];
                    board.Play(n);
                ...
                currentBoards = remainingBoards;
            }

            return winners.Last().SumOfUnmarked() * lastWinningNumber;
        }
